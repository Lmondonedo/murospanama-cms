...
export interface ApiAboutAbout extends Struct.SingleTypeSchema {
  ...
  attributes: {
    ...
    images: Schema.Attribute.Media<'images' | 'files', true> &
      Schema.Attribute.Required;
    keyStats: Schema.Attribute.Component<'shared.stat-block', true>;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
...
export interface ApiCompanyCompany extends Struct.SingleTypeSchema {
  ...
  attributes: {
    ...
    logo: Schema.Attribute.Media<'images' | 'files'> &
      Schema.Attribute.Required;
    mapLocation: Schema.Attribute.Text;
    name: Schema.Attribute.String;
    phone: Schema.Attribute.String;
    publishedAt: Schema.Attribute.DateTime;
    schedule: Schema.Attribute.Component<'shared.schedule-day', true> &
      Schema.Attribute.Required;
    scheduleExceptions: Schema.Attribute.Component<
      'shared.schedule-exception',
      true
    >;
...
export interface ApiProductProduct extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    images: Schema.Attribute.Media<
      ...
      true
    >;
    isRelatedTo: Schema.Attribute.Relation<
      'manyToMany',
      'api::product.product'
    >;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    ...
    pricing: Schema.Attribute.Component<'product.pricing', false>;
    publishedAt: Schema.Attribute.DateTime;
...
export interface ApiTestimonialPageTestimonialPage
  ...
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    description: Schema.Attribute.Blocks;
    isRandom: Schema.Attribute.Boolean & Schema.Attribute.DefaultTo<false>;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
...
export interface ApiTestimonialTestimonial extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    publishedAt: Schema.Attribute.DateTime;
    titleOrLocation: Schema.Attribute.String;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
  };
